* Import ICPSR file 08297-0006, Course Records (Type 2)

program define use_ICPSR_08297_0006_course
    ...
    label define YEARF 9 "NINTH" 10 "TENTH" 11 "ELEVENTH" 12 "TWELFTH" 19 "{UNCODEABLE VERBATIM}" 98 "{MISSING}"
    ...
    infile using "$dctdir/08297-0006-2.dct" if RECTYPE == 2, using("$ICPSR_08297/DS0006/08297-0006-Data.txt")
    
    label data ICPSR_08297_0006_course
